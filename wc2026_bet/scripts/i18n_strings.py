...
STRINGS: dict[str, tuple[str, str]] = {
    ...
    "path.pyr.title": ("פירמידת הסיכויים", "The odds pyramid"),
    "path.pyr.sub": (
        "דירוג כל המשתתפים לפי הסיכוי לסיים במקום הראשון (P מקום 1). לחצו על שם כדי לראות את המסלול שלו.",
        "All entries ranked by their chance to finish 1st (P of 1st). Click a name to see their path."),
    "path.pyr.fav": ("הפייבוריטים", "The favorites"),
    "path.pyr.chal": ("המאתגרים", "The challengers"),
    "path.pyr.dark": ("הסוסים השחורים", "The dark horses"),
    "path.pyr.dream": ("רק נס יעזור", "Only a miracle"),
    "path.pyr.none": ("קחו שמשיה וסעו לים", "Grab a parasol, hit the beach"),
    "path.pyr.count": ("{{n}} משתתפים", "{{n}} entries"),
    "path.pyr.empty": ("— אין משתתפים בדרג זה —", "— no entries in this tier —"),
    "pts.abbr": ("נק׳", "pts"),
    "live.badge": ("חי", "LIVE"),
    ...
    # metric toggle: expected prize vs. probability shifts
    "cheer.m.prize": ("רווח צפוי (₪)", "Expected ₪"),
    "cheer.m.p1": ("סיכוי לניצחון", "P(1st)"),
    "cheer.m.im": ("סיכוי לכסף", "In the money"),
    "cheer.pp": ("%", "%"),
    "cheer.hdimp.prize": ("שינוי בתוחלת הזכייה (₪)", "Change in expected winnings (₪)"),
    "cheer.hdimp.p1": ("שינוי בסיכוי לזכות במקום הראשון (נק׳ אחוז)",
                       "Change in win probability — 1st (pp)"),
    "cheer.hdimp.im": ("שינוי בסיכוי להיכנס לכסף (נק׳ אחוז)",
                       "Change in probability of finishing in the money (pp)"),
